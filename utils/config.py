...
class Config:
    ...
    def __init__(self):
        ...
        # self.num_layers = len([block for block in self.architecture if 'pool' in block or 'strided' in block])
    ...
    #         # AdaptConv parameters
    #         text_file.write('# AdaptConv parameters\n')
    #         text_file.write('# ****************\n\n')
    #         text_file.write('adaptive_feature = {:s}\n'.format(self.adaptive_feature))
    #         text_file.write('first_adaptive_feature = {:s}\n\n'.format(self.first_adaptive_feature))
